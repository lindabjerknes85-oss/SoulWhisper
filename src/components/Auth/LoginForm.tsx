            ...
            <div>
              ...
              <div className="text-center mt-8">
                <button
                  ...
                  className="w-full bg-slate-700 text-cyan-400 hover:bg-slate-600 font-bold py-4 px-6 rounded-lg text-lg transition-all border-2 border-cyan-500 touch-manipulation"
                >
                  Forgot password?
                </button>
              </div>
